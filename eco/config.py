...
class Config:
    ...
    embedding_model = OpenAIEmbeddings(model=os.getenv('OPENAI_EMBEDDING_MODEL'),api_key=os.getenv('OPENAI_EMBEDDING_API_KEY'), base_url=os.getenv('OPENAI_EMBEDDING_BASE_URL'))
